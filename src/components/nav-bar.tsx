  ...
  return (
    <header className="px-6 pt-6 sm:px-12">
      <nav className="mx-auto flex max-w-5xl items-center justify-between">
        <a href="#top" className="flex items-center gap-2 font-display text-xl sm:gap-3">
          <span className="flex items-baseline gap-2">
            rakeeza <span className="font-sans text-sm text-ink/60">ᐢ..ᐢ</span>
          </span>
          <span className="w-fit rotate-[-6deg] bg-marigold px-2.5 py-1 text-[10.5px] font-bold tracking-tight text-forest shadow-[2px_2px_0_rgba(38,34,32,0.14)] whitespace-nowrap">
            available ✨
          </span>
        </a>
